...
var ExistMsg = 0,
    ...
    $.SmartMessageBox = function (settings, callback) {
        ...
        settings = $.extend({
            ...
            placeholder: "",
            options: undefined,
			selected: undefined //FABteam addon
        }, settings);
        ...
        if (settings.input != undefined) {
            ...
            case "select":
                if (settings.options == undefined) {
                    ...
                    InputType = "<div class='form-group'><select class='form-control' id='txt" + SmartMSGboxCount + "'>";
                    ...
                    for (var i = 0; i <= settings.options.length - 1; i++) {
                        if (settings.options[i] == "[") {
                            ...
                            if (settings.options[i] == "]") {
								...
								//FABteam addon
								var selected_option = Name == settings.selected ? 'selected="selected"' : '';
                                Name = "<option "+selected_option+">" + Name + "</option>";
                                InputType += Name;
                            } else {
