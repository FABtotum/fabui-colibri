			...
			<div class="col-sm-6 col-xs-12">
				...
				<span class="show-stat-buttons"> 
					<span class="col-xs-4 col-sm-4 col-md-4 col-lg-4"> 
						<button data-rel="tooltip" data-original-title="<?php echo _("Away from the nozzle"); ?>" type="button" data-action="zHeight" data-attribute="+" class="btn btn-default btn-block action"><i class="fa fa-arrow-down"></i></button>
					</span> 
					<span class="col-xs-4 col-sm-4 col-md-4 col-lg-4"> 
					...
					<span class="col-xs-4 col-sm-4 col-md-4 col-lg-4"> 
						<button rel="tooltip" title="<?php echo _("Closer to the nozzle"); ?>" type="button" data-action="zHeight" data-attribute="-" class="btn btn-default btn-block action"><i class="fa fa-arrow-up"></i></button>
					</span>
				</span>
			</div>
		</div>
