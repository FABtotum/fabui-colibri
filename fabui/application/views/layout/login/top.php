...
<header id="header">
	...
	<?php if($mode == 'login'): ?>
		...
		<?php else: ?>
			<span id="extr-page-header-space"><span class="hidden-mobile hiddex-xs"><?php echo _("Need an account?");?></span>  <a href="<?php echo site_url('login/newAccount') ?>" class="btn btn-primary"> <?php echo _('Create account');?></a>  </span>
		<?php endif;?>
