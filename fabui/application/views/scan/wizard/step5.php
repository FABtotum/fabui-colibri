		...
		<div class="col-sm-12">
			<div class="text-center">
				...
				<div class="button-container text-center">
					...
					<a class="btn btn-default margin-bottom-10 no-ajax" id="download-file"  href="#" target="_blank"><i class="fa fa-download"></i> <?php echo _("Download cloud points file")?> </a>
					<a class="btn btn-default margin-bottom-10 no-ajax" id="download-missing-images" target="_blank"  href="<?php echo site_url('scan/downloadPhotogrammetryMissingImages'); ?>"><i class="fa fa-download"></i> <?php echo _("Download  missing images")?> </a>
				</div>
			</div>
		</div>
	</div>
