	...
	<div id="createFeedContent" class="tab-content padding-10">
			...
			<div class="row">
				...
				<div class="col-sm-<?php echo $type == 'print' ? '6' : '12' ?> show-stats">
					<div class="row ">
						...
						<?php endif; ?>
						<?php if($type == 'mill'): ?>
						<div class="col-xs-6 col-sm-6 col-md-12 col-lg-12"> <span class="text"> <?php echo _('RPM'); ?> <span class="pull-right"><span class="task-rpm"></span> </span> </span>
							<div class="progress">
						...
						<span class="show-stat-buttons"> 
							<span class="col-xs-6 col-sm-6 col-md-6 col-lg-6"> 
								<button type="button" data-action="abort"  class="btn btn-default btn-block  action"><i class="fa fa-stop"></i> <?php echo _('Abort'); ?> <?php echo ucfirst($type) ?></button> 
							</span> 
							<span class="col-xs-6 col-sm-6 col-md-6 col-lg-6"> 
								<button type="button" data-action="pause"  class="btn btn-default btn-block  action isPaused-button"><i class="fa fa-pause"></i> <?php echo _('Pause'); ?> <?php echo ucfirst($type) ?></button> 
							</span> 
						</span>
					</div>
				</div>
		...
		<div class="tab-pane fade in" id="controls-tab">
			...
			<div class="row padding-10">
				...
				<hr class="simple hidden-md hidden-sm hidden-lg">
				<div class="col-sm-6 margin-bottom-50">
					<h4><?php echo _('RPM'); ?> <span class="pull-right"><strong><span class="slider-task-rpm"></span></strong> </span></h4>
