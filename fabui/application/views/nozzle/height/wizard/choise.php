	...
	<div class="col-sm-12">
		<div class="alert alert-warning animated fadeIn margin-bottom-10">
			<ul class="list-unstyled">
				<li><i class="fa fa-exclamation-triangle"></i> <?php echo _("Before proceed make sure nozzle is clean"); ?></li>
	            ...
	            <?php if($settings['probe']['enable']):?>
	            	<li><i class="fa fa-exclamation-triangle"></i> <?php echo _("Z touch probe enabled: probe's length will be automatically calibrated");?></li>
	            <?php endif;?>
         	</ul>
		</div>
	</div>
