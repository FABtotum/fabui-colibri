...
<script type="text/javascript">
	...
	*/
	...
	function changeColdExtrusion(e)
	{
		...
		{
			$.SmartMessageBox({
				title: "<h4><span class='txt-color-orangeDark'><i class='fa fa-warning fa-2x'></i></span>&nbsp;&nbsp; <?php echo _("Turning the cold extrusion protection off might be dangerous if the fillament has not been removed from the head already"); ?>.<br><?php echo _("Do you want to disable cold extrusion?");?></h4>",
				buttons: '[No][Yes]'
