			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="description text-center">
						...
						<p><?php echo _("Insert the filament in the white feeding tube in the spool compartment as shown. You should apply some force to make sure the filament is completely in.."); ?></p>
					</div>
				</div>
			</div>
		</div>
