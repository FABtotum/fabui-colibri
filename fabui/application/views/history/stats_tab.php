...
$total_time_seconds = timeToSeconds($total_time);
					...
					<?php foreach($value_stat as $status => $tot): ?>
						...
						<?php elseif($status == 'total_time'):?>
							<div class="col-sm-12">
								...
								<div class="progress">
									<div class="progress-bar" data-attr="<?php echo timeToSeconds($tot) ?>" style="width: <?php echo @((timeToSeconds($tot)/$total_time_seconds)*100) ?>%;"></div>
								</div>
							</div>
						<?php endif; ?>
						</div>
