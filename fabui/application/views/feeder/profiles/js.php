	...
	**/
	function setFeeder(){
	 	...
	 	$.ajax({
			...
			$(".alerts-container").append('<div class="alert alert-success animated  fadeIn" role="alert"><i class="fa fa-check"></i> Well done! Now your <strong>FABtotum Personal Fabricator</strong> is configured for the <strong>'+ data.name +'</strong>.</div>');			
			setTimeout(function(){
