...
$layout['_css'][] = array('src' => '/assets/css/fabtotum_style.min.css', 'comment'=> 'Fabtotum', 'external' => FALSE);
...
$layout['_js'][] = array('src'=>'/assets/js/fab.app.min.js', 'comment' => 'fab app functions', 'external' => FALSE);
...
$layout['_js'][] = array('src'=>'/assets/js/notification/FabtotumNotification.min.js', 'comment' => 'fabtotum notify', 'external' => FALSE);
$layout['_js'][] = array('src'=>'/assets/js/plugin/fancybox/jquery.fancybox.pack.js', 'comment' => 'fabtotum utilities', 'external' => FALSE);
$layout['_js'][] = array('src'=>'/assets/js/fabtotum.min.js', 'comment' => 'fabtotum utilities', 'external' => FALSE);
