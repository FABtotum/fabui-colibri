...
<script type="text/javascript">
    ...
    $('#modal_link').on('click', function(){
        ...
        function pre_print(){
            ...
            addNozzleTemperature(150);
            addNozzleTargetTemperature(150);
            addBedTemperature(40);
            addBedTargetTemperature(40);
            ...
            $.ajax({
        		  url: '<?php echo module_url('create') ?>ajax/pre_print.php',
        		  dataType : 'json',
                  type: "POST", 
        		  async: true,
        ...
        function engage_feeder(){
            ...
            $.ajax({
        		  url:  '<?php echo module_url('create') ?>ajax/engage_feeder.php',
        		  dataType : 'json',
                  type: "POST", 
        		  async: true,
