...
class SweepScan(GCodePusher):
    ...
    def __post_processing(self, camera_file, start, end, z_offset, y_offset, a_offset, slices, cloud_file, task_id, object_id, object_name, file_name):
        """
        """
        threshold = 0
        idx = 0
        ...
        while True:
            ...
            points = tricpp.sweep_line_to_xyz(xy_line, M, R, t, head_x, head_y, z_offset, w, h)
    ...
    def run(self, task_id, object_id, object_name, file_name, camera_file, start_x, end_x, a_offset, y_offset, z_offset, slices, cloud_file):
        ...
        self.post_processing_thread = Thread(
            ...
            args=( [camera_file, start_x, end_x, z_offset, y_offset, a_offset, slices, cloud_file, task_id, object_id, object_name, file_name] )
            )
