...
hole_image=np.zeros((img_width,slices+1,3), np.uint8)  #create new empty numpy for colored map
texture_image=np.zeros((img_width,slices+1,1), np.uint8)  #create new empty numpy for greyscale
