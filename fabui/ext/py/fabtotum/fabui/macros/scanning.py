...
def check_pre_scan(app, args = None, lang='en_US.UTF-8'):
    ...
    app.macro("G0 Z-"+str(feeder_disengage_offset)+" F300",   "ok", 100, _("Engaging 4th axis") )
...
def end_scan(app, args = None, lang='en_US.UTF-8'):
    ...
    app.macro("G0 E0 F5000",            "ok", 100,  _("Returning to zero"), verbose=False)
    app.macro("G0 Z140 F5000",          "ok", 100,  _("Lowering bed"), verbose=False)
